...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
        ...
        protected virtual decimal GetOrderSubtotalDiscount(Customer customer, decimal orderSubTotal, out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            var subtotalDiscountAmount = discountPrice.DiscountAmount > decimal.Zero ? discountPrice.DiscountAmount : decimal.Zero;
        ...
        protected virtual decimal GetShippingDiscount(Customer customer, decimal shippingTotal, out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            var shippingDiscountAmount = discountPrice.DiscountAmount > decimal.Zero ? discountPrice.DiscountAmount : decimal.Zero;
            if (_shoppingCartSettings.RoundPricesDuringCalculation)
        ...
        protected virtual decimal GetOrderTotalDiscount(Customer customer, decimal orderTotal, out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            var totalDiscountAmount = discountPrice.DiscountAmount > decimal.Zero ? discountPrice.DiscountAmount : decimal.Zero;
            if (_shoppingCartSettings.RoundPricesDuringCalculation)
